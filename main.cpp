...
#include "ble/services/LabService.h"
...
const static char DEVICE_NAME[] = "Heartrate_Team6";
...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _mag_uuid(GattService::UUID_HEART_RATE_SERVICE),
        _mag_value(0),
        _mag_service(ble, _mag_value),
        _heartrate_uuid(GattService::UUID_HEALTH_THERMOMETER_SERVICE),
        _heartrate_value(100),
        _heartrate_service(ble, _heartrate_value, HeartRateService::LOCATION_FINGER),
        // _lab_service(ble, _heartrate_value, HeartRateService::LOCATION_FINGER),
        // _environment_service(ble),
...
private:
    ...
    void start_advertising()
    {
        ...
        _adv_data_builder.setLocalServiceList({&_mag_uuid, 1});
    ...
    void update_sensor_value()
    {
        ...
        _mag_service.updateHeartRate(pMagXYZ[0], pMagXYZ[1], pMagXYZ[2]);
